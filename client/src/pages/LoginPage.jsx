    ...
    sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'> 
      ...
      gap-6 rounded-lg shadow-lg'>
        ...
        {currState === 'Sign up' && !isDataSubmitted && (
          <input type='text' onChange={(e)=>setFullName(e.target.value)}  className='p-2 border border-gray-500 rounded-md focus:outline-none' placeholder='Full Name' required value={fullName}  />
         )}
         {!isDataSubmitted && (
            <>
          ...
          { currState === 'Sign up' && isDataSubmitted && (
            ...
            focus:ring-2 focus:ring-indigo-500' required placeholder='Enter your Bio....'/>
          )}
